...
var (
	// DefaultAllowedClients are "06-solomachine", "99-ostracon" and "07-tendermint"
	DefaultAllowedClients = []string{exported.Solomachine, exported.Ostracon, exported.Tendermint}
