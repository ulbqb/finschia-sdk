...
func WitnessStep(witness *types.Witness, challenge *types.Challenge) (*State, error) {
	...
	// - get pre app hash from da module
	...
	images[localPreimageKey(0)], _ = hex.DecodeString("7d682198accf63e24956cd7883c8704154d968b24aaa7b1050f97d8204e11b1a") // defender assertion, this is malicious state, see demo/tools/data/height-100-defender.json
